...
export default function SubHero({ title, subtitle, image }) {
  return (
    <header className="h-[50vh] w-screen relative">
      <div className="subhero relative flex max-[1024px]:flex-col overflow-hidden h-[50vh]">
        <div className=" uppercase hero-content flex flex-col justify-center items-center absolute h-full w-screen">
          <h1 className="z-10 text-red-600 mx-[50px max-[1024px]:mx-[20px]  max-[1024px]:text-2xl text-5xl font-[200] text-center">
            {title}
          </h1>
